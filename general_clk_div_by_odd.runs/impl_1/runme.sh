...
HD_PWD='C:/Users/abhis/general_clk_div_by_odd/general_clk_div_by_odd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log general_clk_div_by_odd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source general_clk_div_by_odd.tcl -notrace
