...
HD_PWD='C:/Users/abhis/general_clk_div_by_odd/general_clk_div_by_odd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log general_clk_div_by_odd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source general_clk_div_by_odd.tcl
